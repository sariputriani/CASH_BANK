    ...
    public function store(Request $request)
{
    ...
    if ($pakaiSplit) {
        foreach ($request->split['kredit'] as $i => $nilai) {
            BankKeluarDetail::create([
                'id_bank_keluar'        => $bankKeluar->id_bank_keluar,
                'id_kategori_kriteria'  => $request->split['kategori'][$i],
                'id_sub_kriteria'       => $request->split['sub_kriteria'][$i],
                'id_item_sub_kriteria'  => $request->split['item'][$i],
                'kredit'                => $nilai,
            ]);
        }
    }
