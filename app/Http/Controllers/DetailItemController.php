...
use App\Exports\excelDetailItem;
...
//     if ($request->filled('tanggal') && $request->tanggal != 'Semua Tanggal') {
//         $bankMasuk->whereDay('bank_masuk.tanggal', $request->tanggal);
//     }
...
//     // Filter sumber dana jika ada
//     if ($request->filled('sumber_dana') && is_numeric($request->sumber_dana)) {
...
//     // Filter tanggal jika ada
//     if ($request->filled('tanggal') && $request->tanggal != 'Semua Tanggal') {
//         $bankKeluar->whereDay('bank_keluars.tanggal', $request->tanggal);
//     }
...
//     // Siapkan info filter untuk ditampilkan
//     $filterInfo = [];
//     if ($request->filled('bulan') && $request->bulan != 'Semua Jenis Bulan') {
//         $bulanNama = [
...
//     }
//     if ($request->filled('bank_tujuan') && is_numeric($request->bank_tujuan)) {
//         $bankTujuanNama = DB::table('bank_tujuan')->where('id_bank_tujuan', $request->bank_tujuan)->value('nama_tujuan');
//         $filterInfo[] = 'Bank: ' . $bankTujuanNama;
//     }
//     if ($request->filled('sumber_dana') && is_numeric($request->sumber_dana)) {
//         $sumberDanaNama = DB::table('sumber_dana')->where('id_sumber_dana', $request->sumber_dana)->value('nama_sumber_dana');
//         $filterInfo[] = 'Sumber Dana: ' . $sumberDanaNama;
//     }
//     if ($request->filled('id_jenis_pembayaran') && is_numeric($request->id_jenis_pembayaran)) {
//         $jenisPembayaranNama = DB::table('jenis_pembayarans')->where('id_jenis_pembayaran', $request->id_jenis_pembayaran)->value('nama_jenis_pembayaran');
//         $filterInfo[] = 'Jenis Pembayaran: ' . $jenisPembayaranNama;
//     }

//     return view('cash_bank.detail.detailItem', compact(
//         'data',
//         'kategori',
//         'sub',
//         'item',
...
public function index(Request $request)
{
    ...
    public function export_excel(Request $request){
        ...
        return Excel::download(new excelDetailItem($request), 'detail_'.$item.'_'.$tahun.'.xlsx');
    }
    ...
    return view('cash_bank.exportPDF.itemPdf', compact(
        'data',
        'kategori',
        'sub',
        'item',
