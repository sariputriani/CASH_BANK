...
//     $sumberDanaIds = $request->sumber_dana;
//     $kategoriIds = $request->kategori;
//     $jenisPembayaranId = $request->jenis_pembayaran; // Tambahkan ini
//     $rekapanVA = $request->rekapanVA;
...
//     if ($sumberDanaIds && count($sumberDanaIds) > 0) $activeFilters[] = 'sumber_dana';
//     if ($kategoriIds && count($kategoriIds) > 0) $activeFilters[] = 'kategori';
//     if ($jenisPembayaranId && count($jenisPembayaranId) > 0) $activeFilters[] = 'jenis_pembayaran';
...
//     ->when($jenisPembayaranId && count($jenisPembayaranId) > 0, fn($q) => $q->whereIn('id_jenis_pembayaran', $jenisPembayaranId))
//     ->orderBy('tanggal', 'asc')
//     ->get();
