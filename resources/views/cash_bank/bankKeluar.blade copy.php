                    ...
                    <div class="table-responsive d-none d-xl-block">
                        <table class="table table-hover table-bordered align-middle">
                            <thead class="table-primary text-center">
                                <tr>
                                    <th class="sticky-col sticky-check" style="width: 40px;"><input type="checkbox" id="select_all_ids"></th>
                                    <th class="sticky-col sticky-no" style="width: 50px;">No</th>
                                    <th class="sticky-col sticky-agenda">Agenda</th>
                                    <th class="sticky-col sticky-bukti" >No Bukti</th>
                                    <th class="sticky-col sticky-tanggal" >Tanggal</th>
                                    <th>Sumber Dana</th>
                                    <th>Bank Tujuan</th>
                                    <th>Kriteria</th>
                                    <th>Sub Kriteria</th>
                            ...
                            <tbody>
                                ...
                                <tr id="employee_ids{{ $row->id_bank_keluar}}">
                                    ...
                                    <td class="sticky-col sticky-bukti">{{ $index + 1 }}</td>
                                    <td class="sticky-col sticky-tanggal text-nowrap">{{ $row->tanggal }}</td>
...
thead .sticky-col {
    z-index: 5;
    background: #cfe2ff; /* table-primary */
}

/* URUTAN LEFT (HARUS SESUAI LEBAR KOLOM) */
.sticky-check   { left: 0;    width: 40px; }
.sticky-no      { left: 40px; width: 50px; }
.sticky-agenda  { left: 90px; min-width: 150px; }
.sticky-bukti   { left: 240px; min-width: 120px; }
.sticky-tanggal { left: 360px; min-width: 120px; }
